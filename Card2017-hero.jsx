...
export default function Card2017() {
  ...
  // Copy motion (for your kinetic headline)
  ...
  // LIVE "active section" state (no 'once') -> controls chevron visibility
  ...
  return (
    ...
    >
      <div className="era-inner era--roomy">
        ...
        {/* LEFT: phones + top-left ghost year */}
        <motion.div
      ...
      {/* Single bottom chevron anchored to the section */}
      <button
        className="section-cta section-cta--ink"
        data-pos="bottom"
        aria-label="Next era"
        onClick={() => document.getElementById("p2022")?.scrollIntoView({ behavior: "smooth" })}
        title="Next era"
      >
